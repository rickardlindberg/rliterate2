...
class TextField(wx.TextCtrl, WxWidgetMixin):

    def __init__(self, wx_parent, *args):
        wx.TextCtrl.__init__(self, wx_parent)
        WxWidgetMixin.__init__(self, *args)
...
class PageSelectorDialog(Dialog):
    ...
    def _create_widgets(self):
        ...
        sizer["flag"] |= wx.ALL
        sizer["proportion"] = 0
        self._create_widget(TextField, props, sizer, handlers, name)
        props = {}
        sizer = {"flag": 0, "border": 0, "proportion": 0}
        name = None
        handlers = {}
        ...
        sizer["flag"] |= wx.RIGHT
        sizer["proportion"] = 1
        self._create_widget(PageList, props, sizer, handlers, name)
        props = {}
        sizer = {"flag": 0, "border": 0, "proportion": 0}
        name = None
        handlers = {}
...
def text_paragraph_props(paragraph, page_theme, body_width, selection, actions):
    return {
        ...
        "text_edit_props": text_fragments_to_text_edit_props(
            ...
            handler_cls=TextTextFragmentsInputHandler
        ),
    }
...
def text_fragments_to_text_edit_props(paragraph, path, selection, page_theme, actions, align="left", handler_cls=TextFragmentsInputHandler, **kwargs):
    input_handler = handler_cls(
        paragraph,
        path,
        selection,
        actions,

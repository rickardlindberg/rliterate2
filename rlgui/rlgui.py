...
class GuiParser(_Grammar):
    ...
    def __init__(self):
        ...
        I('CALL', 'WS')
        I('MATCH_CHARSEQ', '}')
        I('ACTION', lambda scope: _makeList([(0, 'instance'), (0, '%ifelse'), (0, scope['x'].eval()), (0, scope['xs'].eval()), (0, scope['ys'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 27)
        LABEL(26)
        I('BACKTRACK', 24)

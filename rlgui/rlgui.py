...
class WxCodeGenerator(_Grammar):
    ...
    def __init__(self):
        ...
        LABEL(30)
        I('PUSH_SCOPE')
        I('MATCH_STRING', 'rowscroll')
        I('ACTION', lambda scope: 'RLGuiRowScroll')
        I('POP_SCOPE')
        LABEL(31)
        LABEL(33)
        I('RETURN')

...
class GuiParser(_Grammar):
    ...
    def __init__(self):
        ...
        I('LIST_END')
        I('BIND', 'xs')
        I('ACTION', lambda scope: _makeList([(0, 'widget'), (0, scope['x'].eval()), (0, scope['c'].eval()), (0, scope['layout'].eval()), (0, extract(scope['d'].eval(), 'property')), (0, extract(scope['d'].eval(), 'instance')), (0, join(scope['xs'].eval()))]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('containerType')
        I('PUSH_SCOPE')

...
class GuiParser(_Grammar):
    ...
    def __init__(self):
        ...
        LABEL(3)
        I('ACTION', lambda scope: _makeList([(0, scope['x'].eval()), (0, scope['y'].eval()), (0, _makeList([(0, scope['z'].eval()), (0, scope['as'].eval())]))]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('containerType')
        I('PUSH_SCOPE')
...
class WxCodeGenerator(_Grammar):
    ...
    def __init__(self):
        ...
        I('BIND', 'y')
        I('POP_STREAM')
        I('ACTION', lambda scope: _Builder.create(['class ', scope['name'].eval(), '(', scope['x'].eval(), '):\n', _IndentBuilder(), scope['y'].eval(), _DedentBuilder()]))
        I('POP_SCOPE')
        I('COMMIT', 1)
        LABEL(0)
        I('PUSH_SCOPE')
        I('MATCH_ANY')
        I('ACTION', lambda scope: 'pass # 1')
        I('POP_SCOPE')
        LABEL(1)
        I('RETURN')
        LABEL('topLevel')
        ...
        I('ACTION', lambda scope: 'wx.Frame')
        I('POP_SCOPE')
        I('RETURN')
